...
<footer style="padding-bottom: 0 !important" class="bg-light py-4">
    ...
    <div class="row">
      <div class="col-md-4 text-center text-md-start mb-3">
        ...
        <ul class="list-unstyled mt-3">
          <li><a href="#" class="text-decoration-none text-dark">1073/3 Cộng Hòa, P.7, Q.Tân Bình, TP.HCM</a></li>
  ...
  <div class="bg-white text-black text-left py-2 mt-4 " >
    <p class="mb-0">&copy; Thiết kế và lập trình bởi
      <img style="width: 16%; height: 16%" src="https://mona-winery.monamedia.net/wp-content/uploads/2024/01/logo-mona-thu-gon.png" alt="MonaMedia">
    </p>
  </div>
</footer>

<%--<%@ page import="vn.edu.hcmuaf.fit.sourcedoannoithat.dao.model.CartDisplayItem" %>--%>
...
<%--    CartDisplayItem o = orderDao.getOrderById(Integer.parseInt(productId));--%>
<%--%>--%>
<%--<!DOCTYPE html>--%>
<%--<html lang="en">--%>
...
<%--                    <div class="cartDisplayItem-details">--%>
<%--                        <div class="cartDisplayItem-header">--%>
<%--                            <div class="cartDisplayItem-id">Mã đơn hàng: <%=o.getId()%></div>--%>
<%--                            <div class="cartDisplayItem-date">Ngày đặt: <%=o.getDateOrder()%></div>--%>
<%--                        </div>--%>

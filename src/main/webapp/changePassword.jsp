...
<div>
    ...
    <div class="slider2" style="background-color: #fff; height: 650px">
        <div class="register" style="margin: 64px auto auto auto;border: 2px dashed #6bae0e; height: 330px;">
            ...
            <div class="login">
                ...
                <form action="ChangePassW" method="post">
                    ...
                    <input type="text" id="username" name="username" value="${sessionScope.userNameAccount}" required
                           class="hienthi">

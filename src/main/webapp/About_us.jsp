...
<div>
    ...
    <div class="slider2" style="height: 100%; width: 1200px; margin: 0 auto">
        ...
        <div class="column column-33">
            ...
            <p class="text">
                Chào mừng bạn đến với website của chúng tôi – nơi tự hào cung cấp những sản phẩm nội thất tuyệt đẹp và
                chất lượng hàng đầu.
                Chúng tôi tận hưởng việc thể hiện sự sáng tạo và đam mê trong việc tạo ra không gian sống đẹp, tiện nghi
                và thoải mái cho khách hàng.
            </p>
            <p class="text">
                Chúng tôi cam kết cung cấp cho bạn những sản phẩm chất lượng cao từ những nguyên liệu tốt nhất và công
                nghệ sản xuất tiên tiến nhất.
                Từ các bộ sofa êm ái, bàn ăn hiện đại, đèn trang trí sáng tạo đến giường ngủ thoải mái và tủ quần áo
                thông minh,
                chúng tôi không ngừng nỗ lực để đáp ứng mọi nhu cầu của bạn.
            </p>
        </div>
        <div class="column column-66">
            <div class="banner" style="background-image: url('img/home_index.jpg');margin-top: 70px;">
            </div>
        </div>
    </div>
                ...
                <article class="testimonial">
                    ...
                    <div class="testimonial-info">
                        <img class="testimonial-img"
                             src="https://noithattoz.com/wp-content/uploads/2020/03/906590_933333016686391_1136874957417962322_o-1-300x300.jpg"
                             alt="Mr.Thắng">
                        <div>
